...
- VDJScript verb reference covers ~773 of 989 official verbs (~78%); EQ, `get_browsed_*`, `cue_*`, FX routing, mixer-bypass, browser, and automix clusters added in recent passes

...
Visible in both rounds: button-baseline, button-nothing, button-invalid-alpha, button-invalid-beta, text-literal.

Not visible in both rounds: text-valid-empty, text-invalid-alpha, text-invalid-beta.

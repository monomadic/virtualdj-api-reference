...
Visible in both rounds: baseline, unknown-alpha, unknown-beta, condition-on, misspelled-condition.

Not visible in both rounds: condition-off, invalid-value-alpha, invalid-value-beta.

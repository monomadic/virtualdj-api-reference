...
| [Reference - Grammar Battery Test.xml](Reference%20-%20Grammar%20Battery%20Test.xml) | `Reference - Grammar Battery Test` | `REF: GRAMMAR BATTERY` | Resolve VDJScript grammar unknowns: ternary/`&` precedence, nested-ternary associativity, and backtick-computed action arguments vs `param_*` chaining. |
...
| [Reference - Statement Branch Probe.xml](Reference%20-%20Statement%20Branch%20Probe.xml) | `Reference - Statement Branch Probe` | `REF: STATEMENT BRANCH` | Direct debug calibration, labelled branches and exact bare-debug forms; log absence is not automatically invalid syntax. |

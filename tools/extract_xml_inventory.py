...
Query it with `just get-xml-element` / `list-skin-elements` / `xml-stats`;
...
EXCLUDE = (
    ...
    "tests/Skins/script-validity-probe/",
    "tests/Skins/condition-validity-probe/",
    ...
    return {
        "_meta": {
            ...
            "note": "Element/attribute inventory of every offline XML corpus, "
                    ...
                    "Query via `just get-xml-element` / `list-skin-elements` / "

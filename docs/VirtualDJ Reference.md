...
- Built-in skins:
  Use [examples/Skins/Built-In](../examples/Skins/Built-In/) as semi-official executable examples of skin XML shipped with VirtualDJ.
...
- Built-in plugin UI XML:
  Treat [examples/Skins/Built-In/Plugin-UI/AFX_beatgrid.xml](../examples/Skins/Built-In/Plugin-UI/AFX_beatgrid.xml) as evidence for compact effect/plugin GUI surfaces, not as a full desktop or Remote skin template.
...
- Built-in pad pages:
  Use [examples/Pads/Built-In](../examples/Pads/Built-In/) as semi-official executable examples of pad-page XML shipped with VirtualDJ.
...
- [Built-In/README.md](../examples/Pads/Built-In/README.md)
...
- [Built-In/README.md](../examples/Skins/Built-In/README.md)
...
- [GraveRaver Build Demo](../examples/Skins/GraveRaver/README.md)
...
This is the pattern demonstrated by [ModularSkeleton](../examples/Skins/ModularSkeleton/README.md). Its flattened `build/skin.xml` output is the installed-form reference.
...
Use [ModularSkeleton](../examples/Skins/ModularSkeleton/README.md) as the starting point.

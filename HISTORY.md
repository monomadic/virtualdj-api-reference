...
Note: Completed 2026-09-24. The inventory and literal nesting graph now read Atomix add-on skins
with separate `addon` provenance; the inventory lists source files per element. New names were
triaged in `docs/Skin SDK.md`, and the deliberate `zzscratchwave` negative control was excluded.
The reader vocabulary was re-anchored to installed build 18.0.9644; `just check` passes.

Original scope: opened 2026-09-24. The add-on trees (`examples/Skins/Official-Addons/`, 32 skins in 40
